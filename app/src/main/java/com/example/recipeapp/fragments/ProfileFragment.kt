...
class ProfileFragment : Fragment() {
    ...
    private fun init() {
        ...
        logoutButton.setOnClickListener {
            logout(this) // Pass context to logout function
        }
    }
    ...
    private fun showUserName() {
        ...
        val userName = sharedPreferences.getString("userName", "Guest") // Default "Guest" if name not found
        binding.userNameTv.text = userName // Set the retrieved user name to TextView
    }

    private fun logout(profileFragment: ProfileFragment) {
        val sharedPreferences = requireContext().getSharedPreferences("MyPrefs", Context.MODE_PRIVATE)
